...
unsafe extern "C" {
	...
	pub safe fn adc_absolute(state: &mut State, val: u16);
	pub safe fn adc_absolute_x(state: &mut State, val: u16);
	pub safe fn adc_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn and_absolute(state: &mut State, val: u16);
	pub safe fn and_absolute_x(state: &mut State, val: u16);
	pub safe fn and_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn asl_absolute(state: &mut State, val: u16);
	pub safe fn asl_absolute_x(state: &mut State, val: u16);
	...
	pub safe fn bit_absolute(state: &mut State, val: u16);
	...
	pub safe fn cmp_absolute(state: &mut State, val: u16);
	pub safe fn cmp_absolute_x(state: &mut State, val: u16);
	pub safe fn cmp_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn cpx_absolute(state: &mut State, val: u16);
	pub safe fn cpy_immediate(state: &mut State, val: u8);
	pub safe fn cpy_zero_page(state: &mut State, val: u8);
	pub safe fn cpy_absolute(state: &mut State, val: u16);
	pub safe fn dec_zero_page(state: &mut State, val: u8);
	pub safe fn dec_zero_page_x(state: &mut State, val: u8);
	pub safe fn dec_absolute(state: &mut State, val: u16);
	pub safe fn dec_absolute_x(state: &mut State, val: u16);
	...
	pub safe fn eor_absolute(state: &mut State, val: u16);
	pub safe fn eor_absolute_x(state: &mut State, val: u16);
	pub safe fn eor_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn lda_absolute(state: &mut State, val: u16);
	pub safe fn lda_absolute_x(state: &mut State, val: u16);
	pub safe fn lda_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn ldx_absolute(state: &mut State, val: u16);
	pub safe fn ldx_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn ldy_absolute(state: &mut State, val: u16);
	pub safe fn ldy_absolute_x(state: &mut State, val: u16);
	...
	pub safe fn lsr_absolute(state: &mut State, val: u16);
	pub safe fn lsr_absolute_x(state: &mut State, val: u16);
	...
	pub safe fn ora_absolute(state: &mut State, val: u16);
	pub safe fn ora_absolute_x(state: &mut State, val: u16);
	pub safe fn ora_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn rol_absolute(state: &mut State, val: u16);
	pub safe fn rol_absolute_x(state: &mut State, val: u16);
	...
	pub safe fn ror_absolute(state: &mut State, val: u16);
	pub safe fn ror_absolute_x(state: &mut State, val: u16);
	...
	pub safe fn sbc_absolute(state: &mut State, val: u16);
	pub safe fn sbc_absolute_x(state: &mut State, val: u16);
	pub safe fn sbc_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn lax_absolute(state: &mut State, val: u16);
	pub safe fn lax_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn sax_absolute(state: &mut State, val: u16);
	...
	pub safe fn dcp_absolute(state: &mut State, val: u16);
	pub safe fn dcp_absolute_x(state: &mut State, val: u16);
	pub safe fn dcp_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn isc_absolute(state: &mut State, val: u16);
	pub safe fn isc_absolute_x(state: &mut State, val: u16);
	pub safe fn isc_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn rla_absolute(state: &mut State, val: u16);
	pub safe fn rla_absolute_x(state: &mut State, val: u16);
	pub safe fn rla_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn rra_absolute(state: &mut State, val: u16);
	pub safe fn rra_absolute_x(state: &mut State, val: u16);
	pub safe fn rra_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn sre_absolute(state: &mut State, val: u16);
	pub safe fn sre_absolute_x(state: &mut State, val: u16);
	pub safe fn sre_absolute_y(state: &mut State, val: u16);
	...
	pub safe fn ahx_absolute_y(state: &mut State, val: u16);
